...
function link_module {
    if [ ! -d "${KLIPPER_PATH}/klippy/plugins/shaketune" ]; then
        echo "[INSTALL] Linking Shake&Tune module to Klipper plugins"
        ln -frsn ${K_SHAKETUNE_PATH}/shaketune ${KLIPPER_PATH}/klippy/plugins/shaketune
    else
